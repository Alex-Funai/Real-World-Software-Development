...
4. Modify BankStatementAnalyzer.statementAPI() with methods from BankStatementProcessor.
	+ Ex: System.out.println("The total spent on Cheese is: " + bankStatementProcessor.calculateTotalForCategory("CHEESE"));
